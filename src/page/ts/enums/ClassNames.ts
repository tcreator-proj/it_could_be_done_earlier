export const enum ClassNames {
  takeAHomeWorkButton = ".src-features-trainer-trainerTask-components-Task-components-Header--buttonReview--ts9ZK",
  sendForRevisionButton = ".src-features-trainer-trainerTask-components-Task-components-MarkdownEditor--buttonToRework--uChUY",
